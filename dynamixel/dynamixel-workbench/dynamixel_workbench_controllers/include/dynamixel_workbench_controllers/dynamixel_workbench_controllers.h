...
class DynamixelController
{
 private:
  ...
  actionlib::SimpleActionServer<control_msgs::FollowJointTrajectoryAction> *follow_traj_server;
  ...
  std::map<uint8_t, std::string> id2name_;
  std::map<uint8_t, std::string> dynamixel_groups_;
  std::map<std::string, std::vector<uint8_t>> group_id_map_;
  std::map<std::string, const ControlItem*> control_items_;
  std::set<std::string> joint_groups_;
  std::map<std::string, std::map<std::string, const ControlItem*>> group_control_items_;
  ...
  control_msgs::FollowJointTrajectoryFeedback *fol_jnt_tra_fb_;
  control_msgs::FollowJointTrajectoryResult *fol_jnt_tra_res_;
 ...
 public:
  ...
  void initServer();
  void initFollowJointTrajectoryActionServer();
  ...
  void moveJoints(const control_msgs::FollowJointTrajectoryGoalConstPtr &goal);
};
